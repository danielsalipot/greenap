<form>
    <div class="grid lg:grid-cols-3 md:grid-cols-1 sm:grid-cols-1 min-[320px]:grid-cols-1 items-center">
        ...
        <div class="col-start-3 text-right mx-8">
            <label class="text-md text-sisal-darker font-bold"><i class="fal fa-people"></i>Visitors | 1</label>
        </div>
    </div>
</form>
