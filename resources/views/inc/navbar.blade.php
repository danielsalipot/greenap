...
<nav class="bg-white border-b-4 border-sisal-darker fixed w-full border-gray-200 dark:bg-gray-900 dark:border-gray-700">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-8">
        ...
        <div class="hidden w-full md:block md:w-auto min-[320px]:mb-6 sm:mb-6 lg:mb-0" id="navbar-dropdown">
            <ul class="flex flex-col lg:space-x-20 font-bold text-muesli p-4 md:p-0 mt-4 border border-gray-100 rounded-lg sm:bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
                <li>
