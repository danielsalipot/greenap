                    ...
                    <div class="border-2 border-black max-w-full mx-4 px-8 pt-12 pb-8 h-[80%] overflow-y-auto">
                        <div class="flex-1 overflow-x-auto">
                            <div class="grid grid-cols-2">
                                <div class="border-r-2 border-black pr-8 py-8 px-4">
                                    <div class="py-2">
                                        ...
                                        <input type="text" id="fullname" class="w-full bg-transparent border-none">
                                        <hr class="w-full border-none bg-black h-0.5 mt-1">
                                    </div>
                                    <div class="py-2">
                                        <label for="email" class="font-bold text-black text-xl">Email Address:</label>
                                        <input type="email" id="email" class="w-full bg-transparent border-none">
                                        <hr class="w-full border-none bg-black h-0.5 mt-1">
                                    </div>
                                    <div class="py-2">
                                        <label for="subject" class="font-bold text-black text-xl">Subject:</label>
                                        <input type="text" id="subject" class="w-full bg-transparent border-none">
                                        <hr class="w-full border-none bg-black h-0.5 mt-1">
                                    </div>
                                </div>
                            ...
                            <div class="pt-2 px-4">
                                ...
                                <textarea id="message" class="w-full bg-transparent border-2 border-black mt-8" rows="5"></textarea>
                            </div>
                            <div class="pb-4 px-4">
                                <button class="mt-3 bg-muesli rounded-none px-4 py-2 text-black font-bold drop-shadow-coriander">Contact Us</button>
                            </div>
                        </div>
                    </div>
                </div>
